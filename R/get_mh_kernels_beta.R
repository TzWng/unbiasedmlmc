#'@rdname get_mh_kernels_beta
#'@title Get random walk Metropolis-Hastings kernels
#'@description This function takes a beta distribution target (specified through its log-pdf)
...
#'@export
get_mh_kernels_beta <- function(target, Sigma_proposal){
