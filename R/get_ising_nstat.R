#'@title Ising model unbiased natural statistics
...
#'}
#'@export
get_ising_nstat <- function(beta, k = 0, m = 1, size, max_iterations = Inf){
  ...
  sumstate1 <- ising_sum(chain_state1)
  sumstate2 <- ising_sum(chain_state2)
